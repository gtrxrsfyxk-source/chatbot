...
4. **שעות פעילות** - זמינות מערכות ותחזוקות
...
### עבור נציג מוקד טלפוני:
- שאל: "מה הנוהל לטיפול בחיוב עמלה?"
- תקבל: הוראות צעד-אצעד עם מגבלות סכום

### עבור מנהל סניף:
- שאל: "קריטריונים להלוואה עסקית"
- תקבל: מידע מפורט על דרישות ווועדות

### עבור מפתח תוכנה:
- שאל: "איך מבקשים גישה למערכת הליבה?"
- תקבל: תהליכי IT מפורטים עם טפסים
